...
<div id="main-container" class="container">
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url("index.php/user/history")?>">Riwayat Transaksi</a></li>
                        ...
                        <div class="panel panel-smart">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal">
									...
									<<div class="form-group">
                                        <label for="inputFax" class="col-sm-3 control-label">Kontak Pemilik :</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="kota" placeholder="Kota" value="<?php echo $data['no_hp'] ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
