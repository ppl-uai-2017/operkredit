             ...
             <div class="row">
                                ...
                                <!-- Registration Form Starts -->
                                 <!-- Personal Information Starts -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="luas_tanah" value="<?php echo $data['luas_tanah'] ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="kamar_mandi" value="<?php echo $data['kamar_mandi'] ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="luas_bangunan" value="<?php echo $data['luas_bangunan'] ?>" placeholder="Luas Bangunan">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputFax" class="col-sm-3 control-label">Kamar :</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="kamar" placeholder="Jumlah Kamar" value="<?php echo $data['kamar'] ?>" >
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="kota" placeholder="Kota" value="<?php echo $data['kota'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control" name="alamat" placeholder="Alamat Lengkap Rumah" value="<?php echo $data['alamat'] ?>" ><?php echo $data['alamat'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputFax" class="col-sm-3 control-label">Deskripsi Lainnya</label>
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control" name="deskripsi" value="<?php echo $data['deskripsi'] ?>" placeholder="Deskripsi rumah dengan lengkap, contoh : rumah dekat dengan tol, Listrik 1300 watt"><?php echo $data['deskripsi'] ?></textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="panel panel-smart">
                            ...
                            <div class="panel-body">
                                <!-- Registration Form Starts -->
                                    <!-- Personal Information Starts -->*Pilih foto bila ingin mengganti sesuai nomor foto
                                ...
                                <div class="panel-body">
                                    <!-- Registration Form Starts --><!-- Personal Information Starts -->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="total_cicilan" value="<?php echo $data['total_cicilan'] ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="cicilan_ke" value="<?php echo $data['cicilan_ke'] ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="cicilan_perbulan" value="<?php echo $data['cicilan_perbulan'] ?>"
