                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <h5 class="breadcrumbs-title">Motor Bebek</h5>
                            <ol class="breadcrumb">
                                <li><a href="../../">Kembali</a></li>
                                <li>Motor</li>
                                <li class="active">Bebek</li>
                            </ol>
                        </div>
                    </div>

                    <form action="<?php echo base_url("index.php/category/bebek")?>" method="POST">
                        <div class="row">
...
<!-- Mirrored from demo.geekslabs.com/materialize/v2.3/layout03/eCommerce-products-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Nov 2017 10:01:02 GMT -->
</html>