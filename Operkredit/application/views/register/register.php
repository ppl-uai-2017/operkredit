    ...
    <section class="registration-area">
        <div class="row">
			...
			if(isset($_POST['submit'])){
				...
				$password = $_POST['ulangipassword'];
				$username = $_POST['username'];
				
				$userSQL = "INSERT INTO pengunjung (id, nama_depan, nama_belakang, tempat_lahir, tanggal_lahir, jenis_kelamin, email, no_hp, status_pernikahan, alamat, kota, kode_pos, provinsi) VALUES ('$nama_depan', '$nama_belakang', '$tempat_lahir', '$tanggal_lahir', '$jenis_kelamin', '$email', '$no_hp', '$status_pernikahan', '$alamat', '$kota', '$kode_pos', '$provinsi')";
