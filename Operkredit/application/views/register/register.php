...
<div id="main-container" class="container">
    ...
    <?php
    $today = date("H:i:s");
    if($today <= '23:00:00' && $today >= '07:59:59')
    {
        ?>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url("index.php/register/akun_baru")?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" name="email" placeholder="Contoh : abc@operkredit.web.id" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required placeholder="Lengkapi email"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" name="password" required placeholder="Password" pattern=".{6,}" title="Minimal 6 Karakter" oninvalid="this.setCustomValidity('Silahkan Buat Password')"
                                               oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="password" class="form-control" name="konfirmasi" required placeholder="Konfirmasi Password" pattern=".{6,}" title="Minimal 6 Karakter" oninvalid="this.setCustomValidity('Lengkapi Konfirmasi Password')"
                                               oninput="setCustomValidity('')">
                                    </div>
                                </div>
    ...
    <?php
        ...
        {
            echo "<h3 align='center'>Mohon Maaf, Pendaftaran hanya dapat dilakukan pada pukul 08:00 - 23:00 WIB <a href='/'>Kembali</a>  </h3>";
