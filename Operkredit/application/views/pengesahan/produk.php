                    ...
                    <div class="card">
                        ...
                        <div class="content table-responsive table-full-width">
                            <table class="table table-hover table-striped">
                                ...
                                <tr>
                                    <?php
                                    foreach ($unverify as $unverify) {
                                        ?>
                                        <td><?php echo $unverify['idrumah']?></td>
                                        <td><?php echo $unverify['pengoper_kredit']?></td>
                                        <td><?php if($unverify['status'] == "Menunggu"){ echo "<font color='black'>".$unverify['status']."</font>";} elseif($unverify['status'] == "Terverifikasi"){ echo "<font color='#32cd32'>".$unverify['status']."</font>";} elseif($unverify['status'] == "Ditolak") echo "<font color='red'>".$unverify['status']."</font>" ?></td>
                                        <td>
