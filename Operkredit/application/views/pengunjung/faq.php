...
<head>
    ...
    <title>Accordions | Materialize - Material Design Admin Template</title>
        ...
        <nav id="horizontal-nav" class="white hide-on-med-and-down">
            <div class="nav-wrapper">
                <ul id="nav-mobile" class="left hide-on-med-and-down">
                    <li>
                        <a href="index-2.html" class="cyan-text">
                        ...
                        <li class="bold"><a class="collapsible-header  waves-effect waves-cyan active"><i class="mdi-image-palette"></i> UI Elements</a>
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <li class="active"><a href="ui-accordions.html">Accordian</a>
                                    </li>
        ...
        <section id="content">
            ...
            <div id="breadcrumbs-wrapper" class=" grey lighten-3">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <h5 class="breadcrumbs-title">Accordions</h5>
                            <ol class="breadcrumb">
            ...
            <!--start container-->
            <div class="container">
                <p class="caption">Accordion elements that expand when clicked on. They allow you to hide content that is not immediately relevant to the user.</p>
